...
class UserQuizResource extends Resource
{
    ...
    TextInput::make('weight')
        ...
        ->numeric()
        ->minValue(25)  // أدنى وزن مسموح به
        ->maxValue(300),  // أقصى وزن مسموح به
    ...
    TextInput::make('height')
        ...
        Select::make('water_intake')
            ...
            ->afterStateUpdated(function ($state, callable $set) {
                ...
                $criticalConditions = [
                    'pcos', 'metabolic_disorders', 'cancer', 'kidney_disease',
                    'liver_gallbladder_disease', 'pancreas_disease', 'thyroid_issues',
                    'digestive_disorders', 'pregnant_breastfeeding', 'diabetes_type_1',
                    'eating_disorders', 'vegan', 'diabetes_type_2', 'heart_disease_stroke'
                ];
